  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div
          className={`col-span-1 md:col-span-4 ${isMobile && showMobileDetail ? "hidden" : "block"}`}
        >
                  ...
                  if (isMobile) {
                    ...
                    if (containerRef.current) {
                      ...
                      const targetY = Math.max(
                        0,
                        rect.top + window.scrollY + yOffset,
                      );
                      window.scrollTo({ top: targetY, behavior: "smooth" });
                    }
                  }
        ...
        <div
          ref={contentRef}
          className={`col-span-1 md:col-span-8 ${isMobile && !showMobileDetail ? "hidden" : "block"} ${isMobile ? "animate-in slide-in-from-right duration-300" : ""}`}
        >
          ...
          <div
            className={`${isMobile ? "" : "bg-white p-6 rounded-2xl border border-slate-200 shadow-sm h-full transition-all hover:shadow-md"}`}
          >
            {currentPattern && (
              <div>
                ...
                <div className="bg-white p-4 rounded-lg border border-slate-300 shadow-sm overflow-x-auto">
                  <h4 className="font-bold text-slate-800 mb-3 text-center">
                    {currentPattern.name} Pattern UML
                  </h4>
